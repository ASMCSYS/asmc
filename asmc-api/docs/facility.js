                    ...
                    content: {
                        'application/json': {
                            schema: {
                                ...
                                properties: {
                                    status: { type: 'boolean', example: true },
                                    message: { type: 'string', example: 'Facility records' },
                                    data: {
                                        type: 'object',
                                        properties: {
                                            result: {
                                                ...
                                                items: {
                                                    ...
                                                    properties: {
                                                        ...
                                                        title: { type: 'string', example: 'Swimming Pool' },
                                                        permalink: { type: 'string', example: 'swimming-pool' },
                                                        banner_url: { type: 'string', example: 'https://example.com/banner.jpg' },
                                                        status: { type: 'boolean', example: true },
                    ...
                    content: {
                        'application/json': {
                            schema: {
                                ...
                                properties: {
                                    status: { type: 'boolean', example: true },
                                    message: { type: 'string', example: 'Location records' },
                                    data: {
                                        type: 'array',
                                        items: {
                                            type: 'object',
                                            properties: {
                                                _id: { type: 'string', example: '507f1f77bcf86cd799439011' },
                                                title: { type: 'string', example: 'Main Sports Complex' },
                                                address: { type: 'string', example: '123 Sports Avenue, City, State 12345' },
                                                status: { type: 'boolean', example: true },
                                            },
                                        },
                                    },
                                            ...
                                            result: {
                                                ...
                                                items: {
                                                    ...
                                                    properties: {
                                                        ...
                                                        address: { type: 'string', example: '123 Sports Avenue, City, State 12345' },
                                                        status: { type: 'boolean', example: true },
                                                        parent_id: { type: 'string', example: '507f1f77bcf86cd799439011' },
                                                        createdAt: { type: 'string', format: 'date-time' },
                                                    },
                                                },
                                            },
                    ...
                    content: {
                        'application/json': {
                            schema: {
                                ...
                                properties: {
                                    status: { type: 'boolean', example: true },
                                    message: { type: 'string', example: 'Category records' },
                                    data: {
                                        type: 'array',
                                        items: {
                                            type: 'object',
                                            properties: {
                                                _id: { type: 'string', example: '507f1f77bcf86cd799439011' },
                                                title: { type: 'string', example: 'Sports & Recreation' },
                                                status: { type: 'boolean', example: true },
                                            },
                                        },
                                    },
