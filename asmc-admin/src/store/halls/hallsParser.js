...
export const hallsListParser = (response, dispatch) => {
    try {
        if (response?.result) {
...
export const hallsBookingListParser = (response, dispatch) => {
    try {
        if (response?.result) {
            response = response.result;
        }
...
export const hallsParser = (response) => {
    try {
        if (response?.result) {
            response = response.result;
        }
