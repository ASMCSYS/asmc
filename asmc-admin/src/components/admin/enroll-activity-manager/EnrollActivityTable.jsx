            ...
            data.map(function (row, index) {
                return (
                    ...
                    >
                        ...
                        <TableCell align="center">
                            <HasPermission permission={PERMISSIONS.ORDERS.ENROLL_ACTIVITY.UPDATE} fallback={
                                <Chip
                                    size="small"
                                    sx={{
                                        fontSize: "0.75rem",
                        ...
                        <TableCell align="center" component="th" scope="row">
                            <HasPermission permission={PERMISSIONS.ORDERS.ENROLL_ACTIVITY.UPDATE} fallback={null}>
                                <IconButtonIcons
                                    title="Edit"
                            ...
                            <HasPermission permission={PERMISSIONS.ORDERS.ENROLL_ACTIVITY.READ} fallback={null}>
                                <IconButtonIcons
                                    title="View"
                            ...
                            <HasPermission permission={PERMISSIONS.ORDERS.ENROLL_ACTIVITY.DELETE} fallback={null}>
                                <IconButtonIcons
                                    title="Delete"
...
export default EnrollActivityComponent;
