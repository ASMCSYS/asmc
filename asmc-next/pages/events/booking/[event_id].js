...
import EventBookingDetails from "@/container/EventBookingDetails";
...
const EventDetailPage = () => {
    ...
    return (
        <>
            <Head>
                <title>{event?.event_name} | Anushaktinagar Sports Management Committee</title>
            ...
            <main>
                ...
                {isLoading ? <Loader show={true} /> : <EventBookingDetails event={event} />}
            </main>
        </>
    );
};
